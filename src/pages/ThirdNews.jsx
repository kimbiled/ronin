    ...
    <div className="font-ppneue flex flex-col items-center gap-3">
      ...
      <div className="flex flex-col mx-auto w-[85%] text-[#9CA3AF]">
        ...
        <p className="mt-2 text-[#090C21] font-book sm25:w-[365px]">
          Ever find yourself re-creating the same buttons, colors, and layouts
          for every project? That’s where a design system comes in. It’s a
          game-changer for teams looking to streamline workflows, save time, and
        ...
        <div className="mt-10 text-[#090C21]">
          ...
          <div ref={(el) => (sectionRefs.current['design-system'] = el)}>
            ...
            <p className="mt-2 leading-[24px] font-book">
              ...
              guidelines, and standards that help your team maintain consistency
              across all projects. It’s like having a blueprint for your entire
              product.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 leading-[24px] font-book">
              ...
              <br /> A design system ensures every button, font, and layout
              feels cohesive, strengthening your brand identity.
            </p>
            ...
            <p className="mt-6 leading-[24px] font-book">
              ...
              <br />
              With ready-to-use components, designers and developers can focus
              on innovation rather than reinventing the wheel.
            </p>
            ...
            <p className="mt-6 leading-[24px] font-book">
              ...
              <br /> Design systems bridge the gap between designers,
              developers, and stakeholders, ensuring everyone’s on the same
              page.
            </p>
          </div>
          ...
          >
            <h2 className="text-[24px] font-medium leading-[34px]">
              How to Get Started:
            </h2>
            <p className="mt-2 leading-[24px] font-book">
            ...
            <p className="mt-2 leading-[24px] font-book">
              · Create a shared library of components with tools like Figma or
              Sketch.
            </p>
            <p className="mt-2 leading-[24px] font-book">
          ...
          >
            ...
            <p className="mt-2 leading-[24px] font-book">
              Start building your design system today and transform the way you
