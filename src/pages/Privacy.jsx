 ...
 const sections = [
  {
    ...
    content: (
      <>
        ...
        <p>
          We may collect personal data when you fill out forms, reach out via email, or contact us for a project. This may include:
        </p>
        ...
        <p>
          We use basic analytics tools to collect:
        </p>
        <ul className="list-disc pl-5 mt-4 space-y-1 ml-1">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4 font-medium">
          All third parties follow strict confidentiality and security standards.
        </p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          To make a request, contact: <a href="mailto:hi@ronindsgn.com"className="underline">hi@ronindsgn.com</a>
        </p>
      </>
    )
  },
  ...
  },
  {
    ...
    content: (
      <p>
        We retain your information only as long as needed to fulfill the purpose for which it was collected.
      </p>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <p>
        We may update this Privacy Policy. The latest version will always be posted on this page.
      </p>
    )
  },
  {
  ...
  return (
    <div className="font-ppneue flex flex-col items-center justify-between text-[#090C21] bg-white">
      ...
      <div className="text-[#090C21AD] mb-16 text-[10px]" >
        ...
        onClick={goHome}>Home</span> / <span className="text-black">Privacy Policy</span>
      </div>

      {/* Заголовок */}
      <h1 className="text-[30px] font-medium mb-8">Privacy Policy</h1>
      <hr />
      <div className="text-xs border-[1px] border-[#D4E0ED] rounded-[12px] w-full p-[16px] flex flex-col gap-[10px] mt-8 mb-8">
        <div>
        <p><span className="font-medium">Effective Date:</span> June 26, 2025</p>
        <p><span className="font-medium">Website:</span><a href="https://ronindsgn.com/"> https://ronindsgn.com/</a></p>
        <p><span className="font-medium">Company:</span> Ronin</p>
      </div>

      {/* Введение (всегда видимое) */}
      <div>
        <p className="mb-4">
          At Ronin, we respect your privacy and are committed to protecting any personal data you share with us. This Privacy Policy explains how we collect, use, and safeguard<br/> your information when you visit our website, submit a request, or interact with our content.
        </p>
        <p>
