  ...
  const sections = [
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 mt-4 space-y-1 ml-8">
            ...
            <li>
              You will not use the Site for any unlawful, misleading, or
              malicious purposes.
            </li>
            <li>
              You will not attempt to interfere with or gain unauthorized access
              to our systems.
            </li>
            <li>
          ...
          <p className="mt-4">
            You agree to use the Site in a respectful, legal, and reasonable
            manner at all times.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 mt-4 space-y-1 ml-8">
            <li>
              Copy, reuse, or modify our content without explicit permission.
            </li>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            We collect and process personal data only as necessary to respond to
            your inquiries and improve our services. For full details, see
            our Privacy Policy.
          </p>
          <p className="mt-4">
            By submitting a form or reaching out to us, you consent to the use
            of your data in accordance with that policy.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            All content on the Site is provided “as is.” While we aim to keep it
            accurate and current, we do not guarantee:
          </p>
          <ul className="list-disc pl-5 mt-4 space-y-1 ml-8">
            <li>
              That the Site will be free of errors or available at all times.
            </li>
            <li>
              That submitted forms or messages will be delivered without
              technical issues.
            </li>
            <li>
              That the Site or email communications are fully secure or immune
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 mt-4 space-y-1 ml-8">
            ...
            <li>
              Loss of data, time, or opportunities arising from use of the Site.
            </li>
            <li>
              Third-party content, links, or platforms accessed via this Site.
            </li>
          </ul>
        </>
      ),
    },
    {
      ...
      content: (
        <p>
          Our Site may include links to external websites (e.g., Behance,
          Instagram). We are not responsible for the content, privacy practices,
    ...
    },
    {
      ...
      content: (
        <p>
          We may revise these Terms at any time. Updates will be posted on this
          page with a new effective date. Continued use of the Site after such
          updates indicates acceptance.
        </p>
      ),
    },
  ...
  return (
    <div className="font-ppneue flex flex-col items-center justify-between text-[#090C21] bg-white">
      ...
      <div className="max-w-[1200px] w-full justify-between mb-[200px]">
        ...
        {/* Заголовок */}
        <h1 className="text-[44px] font-medium mb-16">Terms and Conditions</h1>
        <hr />
