        ...
        <div className="flex flex-col max-w-[1200px] w-full justify-between  mb-[168px]">
          <div className="flex flex-col gap-7">
            ...
            <p className="mt-4 text-[#090C21] font-book text-[24px] leading-[38px]">
              Ever find yourself re-creating the same buttons, colors, and
              layouts for every project? That’s where a design system comes in.
              It’s a game-changer for teams looking to streamline workflows,
                ...
                >
                  ...
                  <span className="text-left">
                    {section.title.includes(' not') ? (
                      <>
                        {section.title.split(' not')[0]} <br /> not{' '}
                        {section.title.split(' not')[1]}
                      </>
                    ) : (
                      section.title
                    )}
            ...
            <div className="max-w-[985px] w-full flex flex-col gap-[40px]">
              ...
              >
                ...
                <p className="mt-4 text-[24px] leading-[38px] font-book">
                  A design system is a centralized library of components,
                  guidelines, and standards that help your team maintain
                  consistency across all projects. It’s like having a blueprint
                  for your entire product{' '}
                </p>
              </div>
              <h4
                className="text-[44px] font-medium mb-5 leading-[44px] mt-10"
              ...
              <div className="text-[#090C21]">
                ...
                <p className="mt-4 text-[24px] leading-[38px] font-book">
                  A design system ensures every button, font, and layout feels
                  cohesive, strengthening your brand identity
                </p>
              </div>
              <div className="mt-4">
                <h2 className="text-[44px] font-medium">
                ...
                <p className="mt-4 text-[24px] leading-[38px] font-book">
                  With ready-to-use components, designers and developers can
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 text-[24px] leading-[38px] font-book">
                  Design systems bridge the gap between designers, developers,
                  and stakeholders, ensuring everyone’s on the same page
                </p>
              </div>
              ...
              >
                ...
                <p className="mt-6 text-[24px] leading-[38px] font-book">
                  · Create a shared library of components with tools like Figma
                  or Sketch
                </p>
                <p className="mt-6 text-[24px] leading-[38px] font-book">
                  · Document guidelines for spacing, typography, and interaction
                  states to keep everyone aligned
                </p>
              </div>

              <div
                className="mt-10 text-[#090C21]"
                ref={(el) => (sectionRefs.current['work-smarter'] = el)}
              >
                <h2 className="text-[44px] font-medium">
                ...
                <p className="mt-4 text-[24px] leading-[38px] font-book">
                  Start building your design system today and transform the way
                  you create digital products!
                </p>
              </div>
            </div>
          </div>
