        ...
        <div className="flex flex-col gap-4 mt-16 w-full">
          ...
          {project.isSingle ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 max-w-[1440px]">
                <img
                  src={project.image2}
                  alt="image1"
                  className="w-full h-auto object-cover"
          ...
          <div className="flex flex-row justify-between w-full mt-28">
            <h3 className="text-[44px] leading-[44px] font-medium">
              Other projects
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            {project.others.map((otherProject) => (
              ...
              >
                ...
                />
                <p
                  className="text-[24px] font-medium mt-8 cursor-pointer"
                  onClick={() => goPages(otherProject.id)}
                >
