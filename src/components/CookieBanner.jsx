...
export default function CookieBanner() {
    ...
    <div className="flex flex-row max-w-[1200px] w-full justify-between relative mx-auto">
        {/* Фоновый баннер на всю ширину экрана */}
        <div className="z-[9999] fixed bottom-0 left-0 w-full bg-white shadow-lg p-4">
            ...
            <div className="max-w-[1200px] mx-auto flex justify-between items-center">
                ...
                <div className="flex gap-8 text-[#090C21] font-medium">
                    ...
                    <button
                        ...
                        className="bg-[#F7F7F6] pl-[34px] pr-[34px] pt-[8px] pb-[8px] rounded-lg"
                    >
                        Allow all cookies
                    </button>
                </div>
