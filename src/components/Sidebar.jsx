...
const Sidebar = () => {
  ...
  return (
    <div className="h-full bg-[#0A1330]">
        <aside className="bg-[#0A1330] text-[#AEB9E1] flex flex-col border border-[#343B4F] rounded-lg h-full 2xl:h-[950px] xl:h-[950px] 2xl:w-[300px] xl40:w-[260px]">
      {/* Return to site */}
