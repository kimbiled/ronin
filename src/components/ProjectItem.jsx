            ...
            <div className="emblas__slide" key={index}>
              <div className="relative ">
                <img
                  src={src}
                  alt={`Avatar ${index}`}
                  className="emblas__slide__image "
                />
                {index === 0 && item.profile.followers && (
                  <div
                    className={`font-book absolute sm25:bottom-3 sm25:right-3 sm75:bottom-2 sm75:right-2 sm20:bottom-3 sm20:right-3 ${backgroundColor} 
