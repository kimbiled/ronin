        ...
        {isHovered && (
          <>
            ...
            >
              ...
              {description2 && (
                <p className="text-lg font-book">{description2}</p>
              )}
            </motion.div>
            {country && (
              <motion.img
              ...
              >
                {tags.map((tag, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <span className="font-book text-[22px] text-[#FFFFFF] rounded-[100px] bg-backdrop-blur-[24px] bg-white bg-opacity-10 pl-[18px] pr-[18px] pt-[4px] pb-[4px]">
                      {tag}
                    </span>
                    {isMain && index !== tags.length - 1 && (
            ...
            {(verified || starred) && (
              ...
              >
                {badgeImage && (
                  <img src={badgeImage} alt="Badge" className="w-8 h-8 mr-2" />
                )}
