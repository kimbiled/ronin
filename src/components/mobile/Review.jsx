...
const Review = () => {
  ...
  return (
    <div
      id="reviews"
      className="font-ppneue flex flex-col w-[85%] mx-auto mt-8"
    >
      ...
      <div className="flex flex-row items-center gap-4">
        <p className="font-medium sm25:text-[38px] sm75:text-[32px]  sm20:text-[24px] text-[#090C21]">
          & 859 Completed
        </p>
      </div>
      <div className="flex flex-row items-center gap-4">
        <button
          className="h-10 w-48 border border-[#090C21] rounded-md overflow-hidden flex items-center justify-center relative"
          onClick={() =>
