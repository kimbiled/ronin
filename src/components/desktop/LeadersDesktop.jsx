...
const ContentDesktop = () => {
  ...
  const handleClick = () => {
    window.location.href =
      'https://drive.google.com/file/d/1FizTso9ZKKUooa-Rl6n0Sz6khVYuJCa1/view?usp=sharing'; // Вставь свою ссылку
  };
    ...
    <div className="font-ppneue flex flex-col w-[85%] items-center mt-20">
      <div className="mt-[100px] flex flex-row max-w-[1200px] w-full justify-between">
        <div className="relative flex flex-col items-center gap-4">
          <div
            ref={counterRef}
            className="w-[520px] h-[280px] rounded-[24px] p-12 bg-[#F7F7F6] flex flex-col justify-between"
          >
            ...
            <div className="flex justify-end items-center gap-3 mt-auto">
              ...
              <div
                className="h-12 w-12 bg-[#1261FC] rounded-lg flex justify-center items-center cursor-pointer"
                onClick={handleClick}
              >
