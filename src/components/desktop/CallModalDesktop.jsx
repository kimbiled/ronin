        ...
        {submitted ? (
          ...
          <>
            ...
            <div className="max-w-[720px] w-full pb-[55px] pt-[55px] pl-[69px] flex flex-col gap-7">
              ...
              <div>
                <p className="text-[22px] text-[#090C21] leading-[30px] font-book">
                  Get answers to your questions and see how Ronin can
                  <br /> streamline your design and development
                </p>
              </div>
              <div className="flex flex-col items-start">
                <p className="mb-6 font-book text-[22px] leading-[24px] text-[#9CA3AF]">
                  Clients trust us
                </p>
...
const StepFinal = ({ onReset }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center w-full">
      ...
      <h2 className="text-[44px] font-medium text-[#1261FC] leading-[48px] mt-4">
        Thank You!
      </h2>
      <p className="text-[22px] leading-[28px] font-medium mt-2">
        Your email is already in our priority mailbox
      </p>
      <p className="text-[22px] leading-[28px] font-book mt-2">
