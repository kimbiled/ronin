...
const projects = [
  {
    images: [antix1, antix2, antix3, antix4, antix5, antix6],
    logo: p11,
    title: 'p1',
    description: 'Website design',
    description2: ' and development',
    country: usa,
  ...
  },
  {
    ...
    highlight: '600.000+ Users',
    verified: true,
    badgeImage: verify,
  },
  {
    images: [orb1, orb2, orb3, orb4],
    logo: p33,
  ...
  {
    images: [nas1, nas2, nas3, nas4, nas5, nas6],
    logo: cryptoInd,
    description: 'Website development',
    country: stvincent,
    tags: ['Frontend Development', 'Custom Web Solutions', 'Web3'],
...
export default function ProjectsDesktop() {
  ...
  const handleClick = () => {
    window.location.href =
      'https://drive.google.com/file/d/15t6fMY4dYh54MsYRphr_bPqehjTpZIZC/view?pli=1'; // Вставь свою ссылку
  };
  return (
    <div
      id="recentProjects"
      className="font-ppneue flex flex-col w-[85%] items-center mt-[68px]"
    >
      <div className="flex flex-col max-w-[1200px] w-full justify-between items-center">
        <h3 className="font-medium text-[84px] leading-[92px]">
          Recent projects
        </h3>
        ...
        <div className="flex flex-row gap-[18px] mt-7  w-full">
          <div className="flex flex-col gap-[18px] items-center  w-full">
            ...
            <ProjectCard {...projects[9]} index={10} />
            <ProjectCard {...projects[6]} index={5} />
            <ProjectCard {...projects[8]} index={6} />
            <ProjectCard {...projects[12]} index={13} />
            <ProjectCard {...projects[13]} index={14} />
          </div>
          <div className="flex flex-col gap-[18px] items-center  w-full">
            <ProjectCard {...projects[4]} index={7} />
            <ProjectCard {...projects[5]} index={8} />
            <ProjectCard {...projects[7]} index={9} />
            <ProjectCard {...projects[10]} index={11} />
            <ProjectCard {...projects[11]} index={12} />
            <div className="relative mx-auto py-24">
              <motion.img
                src={metall}
                alt="Metall Project"
                className="w-[400px] h-[400px]relative transition-transform duration-200 ease-in-out hover:scale-110 cursor-pointer"
              ...
              <div className="pointer-events-none absolute inset-x-0 top-1/2 transform -translate-y-1/2 text-white text-[34px] font-book whitespace-nowrap text-center w-full">
                View all works
              </div>
              {visible && (
                <div
